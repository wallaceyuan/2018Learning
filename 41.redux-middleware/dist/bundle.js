    ...
    _createClass(Counter, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { onClick: this.props.increment.bind(this, 1) },
                    ' + '
                ),
                _react2.default.createElement(
                    'button',
                ...
                _react2.default.createElement(
                    'button',
                    { onClick: this.promiseClick.bind(this) },
                    ' payload\u8FC7\u4E00\u79D2 + 1 '
                )
            );
        }
...
var TOGGLE_TODO = exports.TOGGLE_TODO = 'TOGGLE_TODO'; //开关切换完成的状态

var SWITCH_TYPE = exports.SWITCH_TYPE = 'SWITCH_TYPE';

var FETCH_DATA = exports.FETCH_DATA = 'FETCH_DATA';

var GETAJAX = exports.GETAJAX = 'GETAJAX';
...
exports.default = {
    ...
    getAjax: function getAjax(payload) {
        console.log('getAjaxgetAjax');
        return {
            type: types.GETAJAX,
            payload: new Promise(function (resolve, reject) {
                _axios2.default.get('https://easy-mock.com/mock/5c6cb037241b092e864e14c8/v1/get_canary_process_detail').then(function (response) {
                    resolve(response);
...
var _compose = __webpack_require__(/*! ../../compose */ "./compose.js");
...
var store = (0, _redux.createStore)(_reducers2.default, (0, _redux.applyMiddleware)(_reduxThunk2.default, logger1, logger2));
...
exports.default = function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { number: 0, data: [] };
    var action = arguments[1];
